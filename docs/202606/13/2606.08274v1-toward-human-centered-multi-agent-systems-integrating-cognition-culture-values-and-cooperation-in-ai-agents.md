...
tags: ["query:llm-ts"]
score: 7.0
evidence: LLM智能体与多智能体系统的综述
tldr: 当前AI智能体主要追求任务效率，忽略人类社会的认知、文化、价值和规范。本文综述六大领域研究，包括认知决策、语言文化、人类价值、人机协作和多智能体协调。指出现有系统缺乏整合认知、文化、价值和社会行为的统一框架。为构建文化感知、价值对齐、认知基础的合作多智能体系统指明方向。
source: arxiv
...
motivation: 人类环境具有社会性和规范性，智能体需具备以人为中心的能力，而非仅任务效率。
method: 综述认知科学、社会语言学、计算社会科学和AI对齐等领域，分析LLM智能体现状与局限。
result: 识别关键差距：缺乏整合认知、文化、价值和社会行为的统一框架。
conclusion: 未来应构建文化感知、价值对齐、认知基础的合作多智能体系统。
---

## 摘要
基于大型语言模型的智能体及多智能体系统的出现，使得从狭隘的任务自动化转向更自主的决策成为可能。尽管在语言生成、规划、工具使用和协调方面取得了进展，但大多数智能体仍将智能视为预测、优化和任务完成。人类环境是社会性和规范性的，人们在有限理性下推理，在文化情境化的语言中交流，并在价值观、信念、信任和社会规范的指导下做出决策。本文认为，未来的AI智能体，特别是那些代表人类行动的智能体，必须从任务能力转向以人为本的能力。我们回顾了六个领域的研究：(1)智能体的演进，(2)人类认知与决策，(3)语言、文化与社会背景，(4)人类价值观与信念系统，(5)人机协作，(6)多智能体协调与人类特征建模。我们综合了认知科学、社会语言学、计算社会科学和AI对齐领域的工作，以及LLM智能体、文化对齐基准、偏好学习、可解释性和智能体社会的最新进展。我们发现了一个关键差距：现有系统未能提供一个将认知、文化、价值观和社会行为整合到自主智能体中的统一框架。最后，我们提出了构建具有文化意识、价值对齐、认知基础和协作的多智能体系统的方向。
